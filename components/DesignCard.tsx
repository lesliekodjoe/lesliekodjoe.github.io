import { design_data } from "@/utils/data";
          ...
          <div className="w-full flex flex-col-reverse md:flex-row md:h-[521px] md:items-center md:gap-x-10">
            <div className="md:w-1/3 mt-10 md:mt-0">
              ...
              <div className="mt-7 flex flex-col gap-y-5">
                <h4 className="text-3xl font-semibold">{design.designInfo.designName}</h4>
                <p className="">
                  {design.designInfo.designDescription}
                </p>
                <a
            ...
            <div className="md:w-2/3 h-full">
              <div className={`w-full h-full ${design.designBgColor}`}>Fill</div>
            </div>
          </div>
        </div>
      ))}
